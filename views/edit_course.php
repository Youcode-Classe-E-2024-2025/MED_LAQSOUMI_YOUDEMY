...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-6">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <?php else: ?>
                <form action="index.php?action=modifierCours" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="contenu" id="contenu" rows="4" required
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo htmlspecialchars($course['contenu']); ?></textarea>
                    </div>
                            ...
                            <?php if (isset($categories) && is_array($categories)): ?>
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?php echo htmlspecialchars($category['id']); ?>"
                                            <?php echo ($category['id'] == $course['categorie_id']) ? 'selected' : ''; ?>>
