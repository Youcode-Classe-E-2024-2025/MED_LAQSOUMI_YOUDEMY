...
<div class="container mt-4">
    <div class="row mb-4">
        <div class="col-md-8">
            ...
            <p class="lead">Discover our wide range of courses and start learning today!</p>
        </div>
        <div class="col-md-4">
                ...
                <div class="card-body">
                    <div class="list-group">
                        ...
                        <?php foreach ($categories as $category): ?>
                            <a href="index.php?action=home&category=<?= $category['id'] ?>" 
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="index.php?action=home&page=course&id=<?= $course['id'] ?>" 
                    ...
                    <ul class="pagination justify-content-center">
                        <?php for ($i = 1; $i <= $coursesData['total_pages']; $i++): ?>
                            <li class="page-item <?= $i === $coursesData['current_page'] ? 'active' : '' ?>">
                                <a class="page-link" 
                                   href="index.php?action=home&p=<?= $i ?><?= isset($_GET['category']) ? '&category=' . $_GET['category'] : '' ?><?= isset($_GET['search']) ? '&search=' . urlencode($_GET['search']) : '' ?>">
                                    <?= $i ?>
                                </a>
                            </li>
                        <?php endfor; ?>
