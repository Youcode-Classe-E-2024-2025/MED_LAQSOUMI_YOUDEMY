...
-- Insérer 30 données dans la table cours
INSERT INTO cours (titre, description, contenu, categorie_id, enseignant_id) VALUES
('Cours de HTML', 'Introduction à HTML', 'Contenu sur HTML', 1, 2),
('CSS pour Débutants', 'Les bases de CSS', 'Contenu CSS', 1, 5),
('JavaScript Avancé', 'JS pour experts', 'Contenu JS', 1, 15),
('Apprendre Photoshop', 'Techniques Photoshop', 'Contenu Photoshop', 2, 8),
('Marketing Réseaux Sociaux', 'SM marketing', 'Contenu SM', 3, 13),
('Introduction à Python', 'Python pour débutants', 'Contenu Python', 1, 7),
('SQL et Bases de Données', 'Maîtrise SQL', 'Contenu SQL', 7, 10),
('Développement Vue.js', 'Vue.js avancé', 'Contenu Vue.js', 6, 14),
('Introduction au PHP', 'Les bases du PHP', 'Contenu PHP', 6, 12),
('Laravel et Backend', 'Laravel complet', 'Contenu Laravel', 6, 11),
('Photographie Numérique', 'Capturer de belles photos', 'Contenu Photo', 5, 4),
('Finance Personnelle', 'Gérez vos finances', 'Contenu Finance', 29, 9),
('Leadership et Management', 'Devenez un leader', 'Contenu Leadership', 8, 6),
('Créativité en Design', 'Boostez votre créativité', 'Contenu Créativité', 2, 3),
('Fitness pour Tous', 'Améliorez votre santé', 'Contenu Fitness', 24, 18),
('Musique et Composition', 'Créez vos morceaux', 'Contenu Musique', 18, 16),
('Art et Expression', 'Art visuel', 'Contenu Art', 17, 20),
('Découvrez la Chimie', 'Bases de la chimie', 'Contenu Chimie', 15, 21),
('Mathématiques Avancées', 'Concepts avancés', 'Contenu Math', 13, 22),
('Apprendre les Langues', 'Les bases de l’anglais', 'Contenu Langues', 4, 19),
('Découvrez l’Histoire', 'Les grandes époques', 'Contenu Histoire', 27, 8),
('Voyages autour du Monde', 'Explorer de nouveaux horizons', 'Contenu Voyage', 28, 17),
('Psychologie Positive', 'Améliorez votre bien-être', 'Contenu Psychologie', 26, 23),
('Jardinage Facile', 'Prenez soin de votre jardin', 'Contenu Jardinage', 20, 25),
('Fitness Avancé', 'Techniques pour experts', 'Contenu Fitness avancé', 24, 5),
('Mode et Tendance', 'Créez votre style', 'Contenu Mode', 23, 2),
('Cuisine du Monde', 'Recettes internationales', 'Contenu Cuisine', 19, 3),
('Danse Moderne', 'Apprenez à danser', 'Contenu Danse', 19, 24),
('Sécurité Informatique', 'Protégez vos données', 'Contenu Sécurité', 12, 15),
('Apprendre les Langues', 'Les bases de l’anglais', 'Contenu Langues', 4, 19),
('Découvrez l’Histoire', 'Les grandes époques', 'Contenu Histoire', 27, 8);
